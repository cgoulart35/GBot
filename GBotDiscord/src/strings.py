...
DIS_BRIEF = "Guess the name of the user you are paired with for a chance to win 10.00 GCoin."
...
DIS_DESCRIPTION = "Guess the name of the user you are paired with for a chance to win 10.00 GCoin."
...
WHODIS_DESCRIPTION = "Start or end a mini-game where you try to guess a random user in the server you are paired with. You have 1 guess, and if you guess correctly you earn 10.00 GCoin. You can play once every hour."
