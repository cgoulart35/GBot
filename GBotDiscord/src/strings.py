...
HYPE_BRIEF = "Set a regular expression to match against new messages in this server, and a list of possible responses to reply to it with. (admin only)"
...
PATREON_BRIEF = "In the GBot Patreon server, specify a server's ID to enable GBot functionality in that server. (patrons only)"
...
REACT_BRIEF = "Set a regular expression to match against new messages in this server, and a list of possible emojis to react to it with. (admin only)"
...
UNMATCH_BRIEF = "Remove an existing regular expression match repsonse in this server. (admin only)"
...
UNMATCH_DESCRIPTION = "Remove an existing regular expression match repsonse in this server. (admin only)"
